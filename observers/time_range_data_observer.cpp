...
TTimeRangeDataObserver::TTimeRangeDataObserver(
...
void TTimeRangeDataObserver::UpdateDataRecordSensorBitViews(TTaskRequestTimeRangeData *fileTask) {
...
void TTimeRangeDataObserver::UpdateDataRecordViews(TTaskRequestTimeRangeData *fileTask) {
	if (mshViews->size() == 0) {
		return;
	}
...
void TTimeRangeDataObserver::UpdateDataRecordView(TTaskRequestTimeRangeData *fileTask) {
	if (mshView->size() == 0) {
		return;
	}
...
void TTimeRangeDataObserver::UpdateData(sysObserverable::IObserverable *data) {
	if (data == NULL) {
		return;
	}
...
void TTimeRangeDataObserver::SetSensorBitViews(std::map<const TSensorBit *, IMnemoshemaView *> &mshSensorBitViews) {
